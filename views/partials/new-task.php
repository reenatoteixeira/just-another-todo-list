<dialog id="create-task-modal" class="w-11/12 max-w-lg rounded-lg backdrop:bg-black/60">
  <div class="bg-gray-50 px-4 pb-4">
    ...
    <p class="text-sm text-gray-400">Fill in the fields below to create a new task. Remember that creating a task will make it public to anyone with access to this site.
  </div>
