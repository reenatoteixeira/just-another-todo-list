<dialog id="edit-task-modal" class="w-11/12 max-w-lg rounded-lg backdrop:bg-black/60">
  ...
  <form action="/config/process.php" method="POST">
    ...
    <div class="px-4 mt-2 mb-4">
      ...
      <textarea name="description" id="edit-task-modal-task-description" rows="4" maxlength="255" class="block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 text-sm placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 md:text-base resize-none"></textarea>
    </div>
